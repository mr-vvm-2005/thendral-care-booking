  ...
  return (
    <header className="bg-white shadow-soft border-b border-border/50">
      <div className="container mx-auto px-4">
        {/* Top Info Bar */}
        <div className="flex flex-wrap items-center justify-between py-3 text-sm border-b border-border/30">
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-2 text-muted-foreground">
              ...
              <span>Mon-Sat: 9:30 AM - 1:00 PM, 5:00 PM - 8:00 PM</span>
            </div>
          </div>
          <div className="flex items-center space-x-2 text-muted-foreground">
        ...
        <nav className="flex items-center justify-between py-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Premium Dental Healthcare</p>
            </div>
          </div>
